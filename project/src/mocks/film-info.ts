export const films = [
  {
    ...
    description: 'A look into the daily (or rather, nightly) lives of three vampires ve lived together for over 100 years, in Staten Island.',
    rating: 7.2,
    scoresCount: 6173,
  ...
  },
  {
    ...
    description: 'A year after their fatherfuneral, three brothers travel across India by train in an attempt to bond with each other.',
    rating: 3.6,
    scoresCount: 165106,
...
export const filmsCards = Array.from(films, (film) => {const name = film.name; const previewImage = film.previewImage; const previewVideoLink = film.previewVideoLink; const id = film.id; const genre = film.genre;
